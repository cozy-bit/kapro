		...
		<>
			<section className='px-2'>
				<div className='flex flex-col items-center gap-6 md:max-w-350 md:m-auto md:items-start md:gap-19'>
					...
					<aside className='bg-white  rounded-2xl  flex flex-col items-start gap-4 p-4 md:flex-row md:justify-between md:w-full md:p-0 md:gap-20	'>
						<div className='flex flex-col items-start gap-4 md:justify-between md:gap-5 md:items-start md:p-5'>
						...
						<img
							src={kargo7292}
							alt='kargo729'
							className='hidden md:block w-150 h-130'
						/>
					</aside>
